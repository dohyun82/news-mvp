...
- 반영 위치: 그룹사 / 유통·F&B·급식 / 플랫폼·테크 / 경쟁사·복지·HR 트렌드 / 시장·소비 트렌드 카테고리. 분류는 검토 화면에서 수동 지정(중복/광고성은 1차 자동 필터)
...
1. `/news/review`에서 뉴스를 수집하고, 5개 카테고리(그룹사 / 유통·F&B·급식 / 플랫폼·테크 / 경쟁사·복지·HR 트렌드 / 시장·소비 트렌드)로 드래그해 분류한 뒤 요약합니다.
